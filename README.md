...
These are streaming listeners. Listeners are `Spout`s that can be connected to downstreams bolts that can then process these messages (e.g. for batching or for building agents).
